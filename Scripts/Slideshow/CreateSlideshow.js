...
$(document).on("change", "#select_category", function () {
    ...
    childDashboards = [];
    itemViews = [];
    slideShowDashboards = categories.find(x => x.Id == selectedCategory).Dashboards;
    var listDashboards = "";
...
$(document).on("change", "#select_dashboard", function () {
    ...
    if (dashboardId != "all" && dashboardId != "") {
        childDashboards = slideShowDashboards.find(x => x.Id == dashboardId).Dashboards;
...
$(document).on("change", "#select_childdashboard", function () {
    ...
    if (itemId != "" && itemId != "all") {
        ...
        itemViews = childDashboards.find(x => x.Id == itemId).ItemViews;
    }
    else if (itemId != "all") {
        itemId = $("#select_dashboard").find("option:selected").val();
        itemViews = slideShowDashboards.find(x => x.Id == itemId).ItemViews;
    }
