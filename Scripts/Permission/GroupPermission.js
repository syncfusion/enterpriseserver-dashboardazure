    ...
    $("#entity-selection").change(function () {
        ...
        $.ajax({
            ...
            success: function (result, data) {
                ...
                if ($("#scope-selection option").length > 0) {
...
function fnGroupPermissionRecordClick(args) {
...
function fnOnGroupPermissionActionComplete(args) {
    $('[data-toggle="tooltip"]').tooltip();
    if (args.model.currentViewData.length == 0) {
        rowBound();
    }
    var groupPermissiongrid = $('#Grid').data("ejGrid");
    if (groupPermissiongrid.getSelectedRecords().length != 0) {
...
function fnGroupPermissionRowSelected(args) {
    var groupPermissiongrid = $('#Grid').data("ejGrid");
    var selectedPermissions = groupPermissiongrid.getSelectedRecords();
...
$(document).on("click", "#delete-multiple-user-permission", function () {
    ...
    doAjaxPost("POST", deleteMultipleGroupPermissionUrl, values, function (data) {
        if (data) {
