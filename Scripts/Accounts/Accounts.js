        ...
        statusCode: {
            ...
            200: function (result) {
                ...
                if (result.Success == true) {
                    var lanTag = result.Value;
                    var returnUrl = getParameterByName("ReturnUrl");
                    var regex = /([a-zA-Z]{2}-[a-zA-Z]{2})$/;
                    if (lanTag != null && (regex.test(returnUrl) || returnUrl == "")) {
                        returnUrl = returnUrl.replace(regex, lanTag);
                    }
            ...
            304: function (result) {
                ...
                if (result.Success == true) {
                    var lanTag = result.Value;
                    var returnUrl = "/dashboards";
                    if (lanTag != null) {
                        returnUrl = "/" + lanTag + returnUrl;
                    }
                    window.location.href = returnUrl;
                } else {
                    $("body").ejWaitingPopup("hide");
