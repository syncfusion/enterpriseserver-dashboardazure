var selectJoinOption = ("[[[Select Join Option]]]").replace("/ '/g", "\\'");
...
var title = "";
var customExpressionColumn = "[[[Custom expression columns]]]";
...
$("#custom-expression-editor-container_wrapper").ejWaitingPopup();
...
$(document).on("click", "#add-condition", function () {
    ...
    if ($(this).siblings("#measure-div").find(".condition-div-statement").length == 0) {
        $("#measure-div").append("<span id='form-message' class='error-message-widget validate-error no-padding col-sm-8 col-xs-8'></span>" +
            "<label class='custom-expression-columns' style='top: 5px;'>" + customExpressionColumn + "</label>" + "<div class='col-sm-12 col-xs-12 condition-div-statement no-padding first-condition'><span class='filterarea'><span class='filterareatext'></span><input type='hidden' class='filterareainput'></span>" + "<a href='javascript:void(0);' title='' class='add-where-local remove-measure-dimension pull-right su su-close'>"
            ...
            "<select id='selected-col-option' data-live-search='true' title='[[[Select Column]]]' class='selectpicker select-condition col-sm-2 col-xs-2 no-padding no-margin' data-size='5'>" +
            "</select>" +
            "</div>" +
            "<input class='add-comparison btn'  type='button' value='[[[Add Comparison Target]]]'>" +
            "<div class='add-comparison-target col-sm-6 col-xs-6' ><span class='remove-comparison su su-close' data-toggle='tooltip' data-container='body' data-placement='right' title='[[[Remove Comparsion Target]]]'></span>" +
            "<div class='col-sm-2 col-xs-1 no-padding column-condition no-margin' id='where-condition'>" +
            "<select id='selected-condition' data-live-search='true' title='[[[Select Condition]]]' class='col-sm-1 col-xs-1 no-padding no-margin' data-size='5'>" +
            ...
            "<select id='switch-value' data-live-search='true' title='[[[Select Target]]]' class='selectpicker col-sm-2 col-xs-2 no-padding no-margin select-value' data-size='5'>" +
            "<option value='' disabled class='hide-option'selected='selected'>[[[Select Target]]]</option>" + "<option value='0'>Condition</option>" + "<option value='1'>Custom</option>" +
            "</select>" +
            "</div>" +
            "<div class='col-sm-5 col-xs-4 no-padding  measure-column-col  target-column no-margin' id='condition-second-col'>" +
            "<select id='selected-col2-option' data-live-search='true' title='[[[Select Column]]]' class='selectpicker select-condition col-sm-2 col-xs-2 no-padding no-margin' data-size='5'>" +
            "</select>" +
            "</div>" +
            "<div class='col-sm-4 col-xs-4 no-padding no-margin add-value'>" +
            "<input type= 'text'  id='value' class=' form-control validation-input'>" + "<span class='add-custom' style='display:none;'>[[[Please enter a numeric value]]]</span>" +
    ...
    '</div>' + '<div class="measure-statement col-sm-12 col-xs-12 no-padding">' +
                      '<div class="col-sm-3 col-xs-3 no-padding measure-column-col column" id="condition-first-col">' +
                       ...
                       '<div class="add-comparison-target col-sm-6 col-xs-6" ><span class="remove-comparison su su-close" data-toggle="tooltip" data-container="body" data-placement="right" title="[[[Remove Comparsion Target]]]"></span>' +
                         '<div class="col-sm-2 col-xs-1 no-padding  column-condition no-margin" id="where-condition">' +
                       '<select id="selected-condition" data-live-search="true" title="[[[Select Condition]]]" class="col-sm-4 col-xs-4 no-padding no-margin" data-size="5">' +
                      '<option value="0" selected="selected" class="su su-equals">Equals</option>' + '<option value="1" class="su su-not-equals">Not Equals</option>' + '<option value="2" class="su su-lesser-than">Less Than</option>' +
                               '<option value="3" class="su su-greater-than">Greater Than</option>' + '<option value="4" class="su su-lesser-than-or-equal-to">Less Than Or Equals</option>' + '<option value="5" class="su su-greater-than-or-equal-to">Greater Than Or Equals</option>' +
                               '</select>' +
                   '</div>' +
                   ...
                   '</div>' +
                     ...
                     '<div class="col-sm-5 col-xs-4 no-padding  measure-column-col  target-column no-margin" id="condition-second-col">' +
                           '<select id="selected-col2-option" data-live-search="true" title="[[[Select Column]]]" class="selectpicker select-condition col-sm-2 col-xs-2 no-padding no-margin" data-size="5">' +
                            '</select>' + '</div>' +
                             '<div class="col-sm-4 col-xs-4 no-padding no-margin add-value">' +
                   '<input type= "text" id="value" class="form-control validation-input">' + '<span class="add-custom">[[[Please enter a numeric value]]]</span>' +
                   '</div>' + '</div>' + '<a href="javascript:void(0);" class="col-md-12  col-sm-12 col-lg-12 col-xs-12 add-where-local" id="add-dimensions">' +
                              '<span class="su su-add"></span>' +
                              '<span class="margin-alignment">Add Where condition</span>' +
                          '</a>' +
    ...
    if (!$(selector).find(".and").hasClass("and-img")) {
        ...
        $(selector).find(".and-img").attr("src", rootBaseUrl + "Content/Images/" + "AND" + ".png");
        $(selector).find(".or").prepend("<img class='or-img'/>");
        $(selector).find(".or-img").attr("src", rootBaseUrl + "Content/Images/" + "OR" + ".png");
        $(selector).find(".nand").prepend("<img class='nand-img'/>");
        $(selector).find(".nand-img").attr("src", rootBaseUrl + "Content/Images/" + "NAND" + ".png");
        $(selector).find(".nor").prepend("<img class='nor-img'/>");
        $(selector).find(".nor-img").attr("src", rootBaseUrl + "Content/Images/" + "NOR" + ".png");
...
$(document).on("click", "#add-dimension-condition", function () {
    if ($(this).siblings("#dimension-div").find(".condition-div-statement").length == 0 && $("#condition-div #measure-div").find(".condition-div-statement").length > 1) {
        $("#dimension-div").append('<div class="col-sm-12 col-xs-12 condition-div-statement margin-dimension-statement no-padding">' + '<div class="col-sm-12 col-xs-12 dimension-statement no-padding">' + '<div class="col-sm-12 col-xs-12 no-padding dimension-each no-margin where">' +
            ...
            '<div class="col-sm-1 col-xs-1 where-class no-padding no-margin text-center">' + '<span id="where">Where</span>' + '</div>' +
                        '<div class="col-sm-2 col-xs-2 no-padding dimension-column-col actual-column no-margin" id="condition-first-col">' +
                           '<select id="selected-col-option" data-live-search="true" title="[[[Select Column]]]" class="selectpicker col-sm-2 col-xs-2 no-padding select-condition" data-size="5">' +
                           '</select>' + '<span class="error-column">' + '</span>' +
                       '</div>' +
                   '<div class="col-sm-2  col-xs-2 no-padding  column-dimension no-margin" id="where-condition">' +
                       '<select id="selected-condition" data-live-search="true" title="[[[Select Condition]]]" class="selectpicker col-sm-2 col-xs-2 no-padding" data-size="5">' +
                            '<option value = "" disabled class="hide-option" selected="selected">[[[Select Condition]]]</option>' +
        ...
        '<option value="5">Exclude</option>' + '</select>' +
                   '</div>' +
                    '<div class="col-sm-2 col-xs-2 no-padding condition-type no-margin" id="condition-type-dimension">' +
                       '<select id="switch-value" data-live-search="true" title="[[[Select Condition]]]" class="selectpicker col-sm-2 col-xs-2 no-padding no-margin select-value-dimension" data-size="5">' +
                              '<option value="" disabled class="hide-option" selected="selected">[[[Select Target]]]</option>' + '<option value="0">Actual</option>' + '<option value="1">Custom</option>' +
                               '</select>' +
                   '</div>' +
                       ...
                       '<select id="selected-value-condition" data-live-search="true" title="[[[Select Value]]]" class="selectpicker col-sm-3 col-xs-3 no-padding" data-size="5" multiple="">' +
                       '</select>' +
                   '</div>' +
        ...
        $(".add-error-msg").html("[[[At least two conditions are needed to add global where condition.]]]").css("visibility", "visible");
    }
    else {
        $(".add-error-msg").html("[[[At least two conditions are needed to add global where condition.]]]").css("visibility", "visible");
        $("#add-condition").addClass("add-first-condition-validation");
     ...
     '<div class="col-sm-2 col-xs-2 join-div no-padding no-margin">' +
         ...
         '<option value="5">Exclude</option>' + '</select>' +
                       '</div>' +
                        '<div class="col-sm-2 col-xs-2 no-padding condition-type no-margin" id="condition-type-dimension">' +
                        '<select id="switch-value" data-live-search="true" title="[[[Select Condition]]]" class="selectpicker col-sm-2 col-xs-2 no-padding no-margin select-value-dimension" data-size="5">' +
                               '<option value="" name="" class="hide-option" disabled="disabled" selected="selected">[[[Select Target]]]</option>' + '<option value="0">Actual</option>' + '<option value="1">Custom</option>' +
                                '</select>' +
                    '</div>' +
                           ...
                           '<select id="select-value-condition" data-live-search="true" title="[[[Select Value]]]" class="selectpicker col-sm-3 col-xs-3 no-padding" data-size="5" multiple="">' +
                               '</select>' +
                       '</div>' +
                        '<div class="col-sm-3 col-xs-3 no-padding add-value-dimension">' +
                    '<input type= "text" class="form-control target-value validation-input" id="value-dimension">' +
...
$(document).on("click", ".add-dimension-again", function () {
    ...
    $(this).parents(".dimension-each").next(".dimension-each").find("div.join-div select#selected-join-option .and-img").attr("src", rootBaseUrl + "Content/Images/" + "AND" + ".png");
    ...
    $(this).parents(".dimension-each").next(".dimension-each").find("div.join-div select#selected-join-option .or-img").attr("src", rootBaseUrl + "Content/Images/" + "OR" + ".png");
    ...
    $(this).parents(".dimension-each").next(".dimension-each").find("div.join-div select#selected-join-option .nand-img").attr("src", rootBaseUrl + "Content/Images/" + "NAND" + ".png");
    ...
    $(this).parents(".dimension-each").next(".dimension-each").find("div.join-div select#selected-join-option .nor-img").attr("src", rootBaseUrl + "Content/Images/" + "NOR" + ".png");
...
$(document).on("change", ".column-dimension", function () {
    ...
    if ($(this).find("option:selected").text() == "Between") {
        ...
        '<input type="text" class="form-control from-date validation-input"/>' + '<span class="date-error">[[[Please select a daterange]]]</span>' + '</div>');
...
$(document).on("change", ".select-value-dimension", function () {
    if ($(this).parent().siblings(".actual-column").find("option:selected").val() == "") {
        ...
        $(this).parent().siblings(".actual-column").find(".error-column").html("[[[Please select a column]]]").css("display", "inline");
...
$(document).on("change", ".measure-column-col select", function () {
    if ($(this).parent("div").hasClass("validation")) {
        $(this).parent("div").removeClass("validation");
        $(this).siblings(".bootstrap-select").removeClass("validation-error");
...
$(document).on("change", ".dimension-column-col select", function () {
    if ($(this).parent("div").hasClass("validation")) {
        $(this).parent("div").removeClass("validation");
        $(this).siblings(".bootstrap-select").removeClass("validation-error");
        $(this).parent("div").find(".error-column").css("display", "none");
    ...
    listDimensionValues = "";
    var itemId = $("#selected_dashboard").find("option:selected").val();
    if ($("#selected_childdashboard").val().toLowerCase() != "all" && $("#selected_childdashboard").val().toLowerCase() != "") {
    ...
    $(showWaitingPopup).append($("<span class='no-padding loader-gif' style='display:block; background-image:url(" + rootBaseUrl + "content/styles/essentialjs/images/waitingpopup.gif); background-size:cover; left:55px; position:absolute; height:30px; width:30px; top:8px;'></span>"));
    $(showWaitingForValues).append($("<span class='no-padding loader-gif' style='display:block; background-image:url(" + rootBaseUrl + "content/styles/essentialjs/images/waitingpopup.gif); background-size:cover; left:110px; position:absolute; height:30px; width:30px; top:8px;'></span>"));
    ...
    $.ajax({
        ...
        '<option value="1">Exclude</option>' + '<option value="3">Between</option>').selectpicker("refresh");
                $(thisParent).find(".add-value-dimension .add-dimension-custom").html("[[[Please enter the date in " + dateFormat + " format.]]]");
            }
            else if (isBoolean) {
                $(thisParent).find(".column-dimension select").html("");
        ...
        '<option value="5">Exclude</option>').selectpicker("refresh");
                $(thisParent).find(".add-value-dimension .add-dimension-custom").html("[[[Please enter a value]]]");
            }
            else {
                $(thisParent).find(".column-dimension select").html("");
                $(thisParent).find(".column-dimension select").append('<option value="" disabled class="hide-option" selected="selected">[[[Select Condition]]]</option>' + '<option value="0">Contains</option>' + '<option value="1">Starts With</option>' + '<option value="2">Ends With</option>' + '<option value="3">Not Contains</option>' + '<option value="4">Include</option>' +
                '<option value="5">Exclude</option>').selectpicker("refresh");
                $(thisParent).find(".from-date-div").remove();
                $(thisParent).find(".condition-type").css("display", "inline");
                $(thisParent).find(".add-value-dimension .add-dimension-custom").html("[[[Please enter a string value]]]");
            }
            for (var i = 0; i < columnDetails.data.length; i++) {
...
function refreshTarget(selector) {
    ...
    $(selector).find("select").append('<option value="" name="" class="hide-option" disabled="disabled" selected="selected">[[[Select Target]]]</option>' + '<option value="0">Actual</option>' + '<option value="1">Custom</option>').selectpicker("refresh");
    $(selector).find("select").selectpicker("refresh");
}
...
function renderDataCondition(conditionCategory, conditionArray, itemName, item) {
    ...
    $.ajax({
        ...
        success: function (data) {
           ...
           '<option value="1">Exclude</option>' + '<option value="3">Between</option>').selectpicker("refresh");
                            $(this).find(".add-value-dimension .add-dimension-custom").html("[[[Please enter the date in " + dateFormat + " format.]]]");
           ...
           '<option value="5">Exclude</option>').selectpicker("refresh");
                            $(this).find(".add-value-dimension .add-dimension-custom").html("[[[Please enter a value]]]");
                        }
                        else {
                            $(this).find(".add-value-dimension .add-dimension-custom").html("[[[Please enter a string value]]]");
                        }
                    ...
                    $("#measure-div .condition-div-statement:eq(" + i + ") .dimension-statement").find(".dimension-each").each(function () {
                        ...
                        var dimensionConditionType = dimensionArray[m][10];
                        var dimensionValueArray = [];
                        dimensionValueArray = dimensionValue.split(",");
                        var conditionType = 0;
                        var listDimensionValues = "";
                        ...
                        $.ajax({
                            ...
                            success: function (result) {
                                ...
                                if (dimensionColumnType.toLowerCase() == "date" && dimensionCondition == "3") {
                                    ...
                                    if (dimensionConditionType.toLowerCase() === "actual" || (dimensionConditionType.toLowerCase() !== "custom" && conditionType > 0)) {
...
function addMeasure(array) {
    $("#measure-div").append("<span id='form-message' class='error-message-widget validate-error no-padding col-sm-8 col-xs-8'></span>" + "<label class='custom-expression-columns' style='top: 5px;'>" + customExpressionColumn + "</label><div class='col-sm-12 col-xs-12 condition-div-statement no-padding first-condition'><span class='filterarea'><span class='filterareatext'></span><input type='hidden' class='filterareainput'></span>" + "<a href='javascript:void(0);' title='' class='remove-measure-dimension pull-right su su-close'>"
        + "</a>" + "<div class='measure-statement col-sm-12 col-xs-12 no-padding'>" +
        "<div class='col-sm-3 col-xs-3 no-padding measure-column-col column' id='condition-first-col'>" +
        "<select id='selected-col-option' data-live-search='true' title='[[[Select Column]]]' class='selectpicker select-condition col-sm-2 col-xs-2 no-padding no-margin' data-size='5'>" +
        "</select>" +
...
'</div>' + '<div class="measure-statement col-sm-12 col-xs-12 no-padding">' +
                  '<div class="col-sm-3 col-xs-3 no-padding measure-column-col column" id="condition-first-col">' +
                       '<select id="selected-col-option" data-live-search="true" title="[[[Select Column]]]" class="selectpicker select-condition col-sm-2 col-xs-2 no-padding no-margin" data-size="5">' +
                         '</select>' +
                   '</div>' +
                   '<input class="add-comparison btn"  type="button" value="[[[Add Comparison Target]]]" tabindex="4" class="secondary-button">' +
                       '<div class="add-comparison-target col-sm-6 col-xs-6" ><span class="remove-comparison su su-close" data-toggle="tooltip" data-container="body" data-placement="right" title="[[[Remove Comparsion Target]]]"></span>' +
                      '<div class="col-sm-2 col-xs-1 no-padding  column-condition no-margin" id="where-condition">' +
                   '<select id="selected-condition" data-live-search="true" title="[[[Select Condition]]]" class="col-sm-4 col-xs-4 no-padding no-margin" data-size="5">' +
                  '<option value="0" selected="selected" class="su su-equals">Equals</option>' + '<option value="1" class="su su-not-equals">Not Equals</option>' + '<option value="2" class="su su-lesser-than">Less Than</option>' +
...
function addDimensionWithMeasureAgain(selector) {
    ...
    if (!$(join).find(".and").hasClass("and-img")) {
        ...
        $(join).find(".and-img").attr("src", rootBaseUrl + "Content/Images/" + "AND" + ".png");
        $(join).find(".or").prepend("<img class='or-img'/>");
        $(join).find(".or-img").attr("src", rootBaseUrl + "Content/Images/" + "OR" + ".png");
        $(join).find(".nand").prepend("<img class='nand-img'/>");
        $(join).find(".nand-img").attr("src", rootBaseUrl + "Content/Images/" + "NAND" + ".png");
        $(join).find(".nor").prepend("<img class='nor-img'/>");
        $(join).find(".nor-img").attr("src", rootBaseUrl + "Content/Images/" + "NOR" + ".png");
...
function saveCondition() {
    ...
    if ($("#data-changes-div-container").find("div").hasClass("validation") || ($("#data-changes-div-container #condition-div #measure-div").html().trim() == "")) {
        ...
        if ($(".items-dropdown").hasClass("validation") && $(".condition-category-changes").hasClass("validation")) {
            ...
            $("#add-condition").addClass("add-first-condition-validation");
            $(".add-error-msg").html("[[[Please add a condition]]]").css("visibility", "visible");
        }
        else {
            $("#add-condition").removeClass("add-first-condition-validation");
            $(".add-error-msg").html("[[[Please add a condition]]]").css("visibility", "hidden");
            $(".error-message-widget").css("display", "none");
    ...
    if (validation != 1) {
        ...
        if ($("#selected_childdashboard").val().toLowerCase() == "all" && $("#selected_childdashboard").val().toLowerCase() != "" && $("#selected_childdashboard").attr("disabled") != "disabled") {
                        ...
                        if ($(this).find(".dimension-statement").length > 0) {
                            ...
                            while (j < countDimension) {
                                $(this).find(".dimension-each").each(function () {
                                    ...
                                    conditionType = $(this).find("#condition-type-dimension option:selected").html();
                                    ...
                                    dimensionArray[j] = [actualColumnDimension[j], valueDimension[j], conditionDimension[j], targetColumnDimension[j], joins[j], conditionType];
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.hasError == false) {
                    ...
                    $("#form-message").show().html("[[[An error has been occurred while evaluating your condition. ]]]" + (data.status == false ? data.validationDescription : ""));
