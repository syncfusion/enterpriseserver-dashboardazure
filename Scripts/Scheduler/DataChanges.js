...
$(document).on("click", "#add-condition", function () {
    ...
    if ($(this).siblings("#measure-div").find(".condition-div-statement").length == 0) {
        $("#measure-div").append('<span id="form-message" class="error-message-widget validate-error no-padding col-sm-8 col-xs-8"></span>'+'<label class="custom-expression-columns" style="top: 5px;">[[[Custom expression columns]]]</label>'+'<div class="col-sm-12 col-xs-12 condition-div-statement no-padding first-condition"><span class="filterarea"><span class="filterareatext"></span><input type="hidden" class="filterareainput"></span>' + '<a href="javascript:void(0);" title="" class="add-where-local remove-measure-dimension pull-right su su-close">'
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var i = 0; i < columnDetails.data.length; i++) {
                ...
                if (columnDetails.data[i].ColumnType == 2) {
...
$(document).on("change", ".measure-column-col select,.dimension-column-col select", function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (columnType == 2 && actualColumnType == "date") {
                    ...
                    $("#measure-div .condition-div-statement:eq(" + i + ") .dimension-statement").find(".dimension-each").each(function () {
                        ...
                        $.ajax({
                            ...
                            success: function (result) {
                                ...
                                if (dimensionColumnType == "date" && dimensionCondition == "3") {
                    ...
                    $("#dimension-div .condition-div-statement .dimension-statement").find(".dimension-each:eq(" + i + ")").each(function () {
                        ...
                        $.ajax({
                            ...
                            success: function (result) {
                                ...
                                if (columnType == "date" && dimensionCondition == "3") {
                                    $(targetSelector).parent("div").css("display", "none");
                                    $(customValue).css("display", "none");
                                    $(targetValue).parent("div").css("display", "none");
                                }
