...
function onSchedulerDialogOpen() {
    $("#scheduler-popup-iframe").attr("src", window.schedulerIframeUrl + "?itemName=" + ItemName + "&&itemId=" + ItemId + "&&categoryName=" + CategoryName + "&&scheduleId=" + ScheduleId + "&&multiDashboardName=" + MultidashboardName + "&&actionType=Edit");
