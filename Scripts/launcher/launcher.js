...
$(document).on("click", "#launcher", function (e) {
    if (i_am_ie9) {
        e.preventDefault();
        messageBox("su-info", "[[[Information]]]", "[[[We are unable to launch the Dashboard Designer from IE 9 browser. Please refer to this <a href='https://help.syncfusion.com/dashboard-platform/dashboard-designer/installation'>link</a> on how to open a Dashboard in Dashboard Designer]]]", "success", function () {
            onCloseMessageBox();
        });
    }
    else {
