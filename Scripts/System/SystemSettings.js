    ...
    if ($(".admin-account-fields-container").valid()) {
        ...
        switch (database) {
            case "mssqlce":
                ...
                break;
            case "mssql":
                var prefix = ($("#table-prefix").val() === "" || $("#new-db").is(":checked")) ? "SyncDS_" : $("#table-prefix").val();
                var databaseName = $("#new-db").is(":checked") ? $("#txt-dbname").val() : $("#databaseName").val();
                break;
            case "mysql":
                var prefix = ($("#table-prefix-mysql").val() === "" || $("#new-db-mysql").is(":checked")) ? "SyncDS_" : $("#table-prefix-mysql").val();
                var databaseName = $("#new-db-mysql").is(":checked") ? "`" + $("#mysql-database-name").val() + "`" : "`" + $("#database-name-mysql").val() + "`";
                break;
            case "oracle":
                var prefix = ($("#table-prefix-oracle").val() === "" || $("#new-db-oracle").is(":checked")) ? "SyncDS_" : $("#table-prefix-oracle").val();
                var databaseName = $("#new-db-oracle").is(":checked") ? $("#client-username").val() : $("#database-name-oracle").val();
                break;
            case "postgresql":
                var prefix = ($("#table-prefix-postgresql").val() === "" || $("#new-db-postgresql").is(":checked")) ? "SyncDS_" : $("#table-prefix-postgresql").val();
...
$(document).on("click", "#sql-existing-db-submit", function () {
    ...
    if (canProceed) {
        ...
        window.password = $("#txt-password-db").val();
        var databaseType = $("#database-type").val();
        var prefix = $("#table-prefix").val() === "" ? "SyncDS_" : $("#table-prefix").val();
...
$(document).on("click", "#mysql-existing-db-submit", function () {
    ...
    if (canProceed) {
        ...
        window.password = $("#mysql-password").val();
        var databaseType = $("#database-type").val();
        var prefix = $("#table-prefix-mysql").val() === "" ? "SyncDS_" : $("#table-prefix-mysql").val();
...
$(document).on("click", "#oracle-existing-db-submit", function () {
    ...
    if (canProceed) {
        ...
        var clientPassword = $("#database-password").val();
        var prefix = $("#table-prefix-oracle").val() === "" ? "SyncDS_" : $("#table-prefix-oracle").val();
...
$(document).on("click", "#postgresql-existing-db-submit", function () {
    ...
    if (canProceed) {
        ...
        var databaseType = $("#database-type").val();
        window.port = $("#postgresql-port").val();
        var prefix = $("#table-prefix-postgresql").val() === "" ? "SyncDS_" : $("#table-prefix-postgresql").val();
