...
function filterView() {
    $("#dashboard-view-toogle").ejWaitingPopup("show");
        ...
        if (parameters != "" && parameters != null && parameters.masterData.length > 0) {
                SavedViewHeight();
...
function unsavedFilters(currentMasterData) {
    ...
    var item = "";
    var result = "";
    if (dashboardviewerObj != "" && dashboardviewerObj != "undefined" && dashboardviewerObj != null && dashboardviewerObj.masterData.length > 0) {
