...
$(document).ready(function () {
    ...
    $(document).on("click", "#share-datasource-with-group", function () {
         ...
         var selectContentsDataSources = parent.$("#update-data-source-popup-iframe").contents().find("select#datasource-search");
         ...
         if ($("#group-search-container").css("visibility") == "visible") {
             ...
             $(selectContentsDataSources).each(function (index, value) {
                 selectedDataSourceId = this.value;
             });
             $(selectContentsGroups[0].childNodes).each(function (index, value, text) {
                 if (this.value == selectedGroup) {
                     selectedGroupName = this.text;
                 }
             });
         }
         if (changedValues.length != 0 || (prevDataSourceName != undefined && selectedGroupName != prevDataSourceName && selectedDataSourceId != "00000000-0000-0000-0000-000000000000")) {
...
$(document).on("click", "button.dropdown-toggle", function () {
    if ($(this).attr("data-id") == "group-search") {
        prevDataSourceName = $(this).context.textContent;
    }
 });
