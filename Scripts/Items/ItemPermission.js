$(document).ready(function () {
    ...
    if ($("#is-owner").val() != undefined && $("#is-owner").val().toLowerCase() == "true") {
    ...
    $(document).on("click", "#groups-tab", function (e) {
        ...
        $("#search-group-permission").val("");
        $(".su-search").css("display", "block");
        $(" .modal-body #group-search-area #clear-search").click();
    });

    $(document).on("click", ".itempermission-popup-close", function (e) {
        eDialog = parent.$("#permission-popup").data("ejDialog");
        $("#itempermissiongrid").ejGrid("option", { dataSource: [] });
        $("#itemgrouppermissiongrid").ejGrid("option", { dataSource: [] });
        eDialog.close();
    });
});
...
$(document).on("click", ".delete-permission", function () {
    ...
    parent.messageBox("su-delete", "[[[Delete Permission]]]", "[[[Are you sure you want to delete this permission?]]]", "error", function () {
...
function fnOnUserGridActionBegin(args) {
    isFirstRequest = true;
    var searchValue = $("#search-user-permission").val();
...
function fnOnGroupGridActionBegin(args) {
    isFirstRequest = true;
    var searchValue = $("#search-group-permission").val();
    this.model.query._params.push({ key: "searchKey", value: searchValue });
    var filerSettings = [], i;
...
$(document).on("click", ".message-box-btn-holder .secondary-button, .message-box-close .su-close", function () {
