var cursorPos, Paste, createHiddenEditable, isFocusable, initialLine, initialPosition, targetElement, itemId, dataManger, elementNode, isMultiDashboard;
...
$(document).ready(function () {
    ...
    if (typeof (itemId) !== 'undefined' && $('#isWidgetComment').val() == 'true') {
...
function refreshCommentScroller() {
    ...
    //For widget iframe
    if ($('#isWidgetComment').val() == 'true') {
        var contentHeight = $("#list_container").outerHeight() + $('.header-section').outerHeight() + textAreaHeight + $('.count-sort').outerHeight() + $('.additional-content').outerHeight();
        var itemId = getUrlVars(window.location.href.split('#')[0])['itemId'];
