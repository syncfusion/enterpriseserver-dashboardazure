...
if (parentRefUrl == "") {
    ...
    parentUrl = parentRefUrl.match(/:\/\/(.[^/]+)/)[1];
}
    ...
    $(document).on('click', '#post-comment', function () {
        ...
        if (isMultiDashboard.toLowerCase() == 'true') {
            ...
            if (itemType.toLowerCase() == 'widget') {
                dashboardItemId = parent.$("#dashboard_Comment").attr("data-item-id");
            }
        }
        ...
        if (isMultiDashboard.toLowerCase() == 'true') {
            ...
            querystring != ""
                ...
                : currentPageUrl = splitUrl[0] + "view?id=" + parentDashboardId + '&tab=' + parent.$(dashboardTypeId).find("li.e-active").find("span").html().trim();
        }
        var commentText = postmd.value();
                    ...
                    if (data) {
                            ...
                            if (cmntCount == 0) {
                                if (itemType == "dashboard") {
                                   parent.$(dashboardTypeId).data(ejType)._toggleDashboardComment();
...
$(document).on("click", "#close-comment", function () {
    ...
    if (parent.$("#is_mobile").val() == "true") {
        ...
        if (parent.$("#server-mobile-navbar .server-comment").hasClass('active')) {
            ...
            parent.$(dashboardTypeId, "#widget").show();
    ...
    if (iframeUrl == parentUrl) {
        parent.$(dashboardTypeId).css("width", $(parent.window).width() - 40 + "px");
